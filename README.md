...
- [Footer Design](https://www.footer.design/): Inspiration for website footer designs
- [Navbar Gallery](https://www.navbar.gallery/): Collection of navigation bar designs
- [Landing Folio](https://www.landingfolio.com/): Showcase of landing page designs
- [Readymag Examples](https://readymag.com/examples/): Sample designs from Readymag platform
- [Lookup Design](https://lookup.design/): Design resource and inspiration hub
- [Godly](https://godly.website/): Curated collection of beautiful websites
- [Web Design Museum](https://www.webdesignmuseum.org/): Archive of historical web designs
- [SiteInspire](https://www.siteinspire.com/): Web design inspiration and showcase
- [Recent Design](https://recent.design/): Gallery of recent web design trends
- [Viewport UI](https://viewport-ui.design/): User interface design examples
- [CSS Nectar](https://cssnectar.com/): CSS showcase and web design awards
- [Lapa Ninja](https://lapa.ninja): Landing page design inspiration
- [One Page Love](https://onepagelove.com): One-page website design gallery
- [UI Garage](https://uigarage.net): User interface design inspiration
- [Page Flows](https://pageflows.com): User flow design examples
- [UI Jar](https://uijar.com): User interface design patterns
- [Ecomm Design](https://ecomm.design): E-commerce website design inspiration
- [Hoverstat.es](https://hoverstat.es): Showcase of creative web design
- [UX Archive](https://uxarchive.com/): Mobile user experience patterns
- [UI Patterns](https://ui-patterns.com/): User interface design pattern library
- [UserOnboard](https://www.useronboard.com/): User onboarding examples and teardowns
- [Empty States](https://emptystat.es/): Collection of empty state designs
- [CSS Design Awards](https://www.cssdesignawards.com/): Web design and development awards
- [Maxi Best Of](https://maxibestof.one/): Curated collection of design resources
- [Logggos Club](https://www.logggos.club): Logo design inspiration
- [Land-book](https://land-book.com/): Landing page inspiration gallery
- [Abduzeedo](https://abduzeedo.com/): Design inspiration and tutorials
- [Flowbase](https://www.flowbase.co/): Web design resources and templates
- [Doing Cool Stuff](https://www.doingcoolstuff.xyz/): Showcase of creative digital projects
- [Screenlane](https://screenlane.com/): Mobile design inspiration
- [Pixelfika](https://pixelfika.com/): Web design inspiration gallery
- [Call to Inspiration](https://calltoinspiration.com/): Web design inspiration and resources
- [Minimal Gallery](https://minimal.gallery/): Minimalist web design showcase
- [Webdesign Inspiration](http://webdesign-inspiration.com): Web design gallery and resources
- [Visual Journal](http://visualjournal.it): Visual design inspiration blog
- [Pretty Folio](https://www.prettyfolio.com/): Portfolio website inspiration
- [Dark Design](http://dark.design): Dark mode design inspiration
- [Design Systems Surf](https://designsystems.surf/design-systems/adobe): Design system examples
- [Superb Themes](https://superbthemes.com/all-framer-templates/): Framer template collection
- [Portfolio Project](https://portfolioproject.io/): Portfolio website showcase
- [Layers](https://layers.to/): Design asset marketplace
- [Seesaw Website](https://www.seesaw.website/): Web design inspiration gallery
- [Appmotion Design](https://appmotion.design/): Mobile app design inspiration
- [Refero Design](https://refero.design/): Design reference and inspiration
- [Pafolios](http://pafolios.com/): Product and UX designer portfolios
- [Deck Gallery](http://deck.gallery): Presentation deck design inspiration
- [Pfolios](http://pfolios.net): Portfolio website showcase
- [Killer Portfolio](http://killerportfolio.com): Outstanding portfolio examples
- [OG Image Gallery](https://www.ogimage.gallery/): Open Graph image design inspiration
- [Landings Dev](https://landings.dev/): Landing page design inspiration
- [Dark Mode Design](http://darkmodedesign.com): Dark theme design inspiration
- [Design Vault](http://designvault.io): Design inspiration and resources
- [Scrnshts Club](https://scrnshts.club/): App screenshot design inspiration
- [SaaS Landing Page](https://saaslandingpage.com/): SaaS website design inspiration
...
- [Taylor Nguyen UX Research Templates](https://taylornguyen.ca/ux-research-templates): Ready-to-use UX research templates
- [Dovetail](https://dovetail.com): Collaborative research and analysis platform
- [UseBerry](https://www.useberry.com): User testing and feedback tool
- [Qualtrics Survey Templates](https://www.qualtrics.com/marketplace/survey-template/): Professional survey templates
...
- [Protopie](https://www.protopie.io/): advanced prototyping tool for dynamic & multimodal interactions


###### Animation Tools
- [Framer](https://www.framer.com/): simpel to use, use it on your prototypes
- [Flow](https://createwithflow.com/): suble learning curve
- [After effects](https://www.adobe.com/my_en/products/aftereffects.html): quite complex
- [Rive](https://rive.app/): familiar tool to create functional and interactive graphics with State Machine
- [Jitter](https://jitter.video/files/): Motion design made simple
...
- [Logo Master AI](https://app.logomaster.ai/create): AI-assisted logo creation
- [Designs AI](https://designs.ai/free-trial): AI-powered design platform
...
- [Huemint](https://huemint.com/): AI-powered color palette generator
- [Atmos](https://atmos.style/): Gradient and color palette tool
...
- [Cosmin's Font Pairings](https://cosmin.work/some-of-my-favourite-font-pairings/): Font pairing suggestions
- [The Good Line Height](https://thegoodlineheight.com/): Tool for determining optimal line height
- [Fontspring](https://www.fontspring.com/search): Font marketplace
- [Collletttivo](https://www.collletttivo.it/): Independent type foundry
- [The League of Moveable Type](https://www.theleagueofmoveabletype.com/): Open-source font foundry
- [Lost Type](http://www.losttype.com/): Pay-what-you-want type foundry
- [Font Squirrel](https://www.fontsquirrel.com/): Free font library
- [Free Design Resources](https://freedesignresources.net/category/free-fonts/): Collection of free fonts
- [MyFonts](https://www.myfonts.com/search?query=free): Font marketplace with free options
- [Fonts In Use](https://fontsinuse.com/): Archive of typography in real-world usage
- [Type Hunting](https://typehunting.com/): Vintage typography inspiration
- [Fonts in the Wild](https://www.fontsinthewild.com/): Typography inspiration from various sources
- [Velvetyne](https://velvetyne.fr/): Free and open-source type foundry
- [Creative Market](https://creativemarket.com/free-goods): Marketplace with free design goods
- [Awwwards Free Fonts](https://www.awwwards.com/awwwards/collections/free-fonts/): Curated collection of free fonts
- [Font Joy](https://fontjoy.com/): Font pairing generator
- [Font Share](https://www.fontshare.com/): Free fonts from Indian Type Foundry
- [Displaay](https://displaay.net/): Type foundry
- [Free Faces](https://www.freefaces.gallery/): Curated collection of free typefaces
...
- [Magic Pattern](https://www.magicpattern.design/): Background pattern generator
- [BG Ibelick](https://bg.ibelick.com/): CSS background pattern generator
